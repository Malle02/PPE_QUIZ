...
/**
 * Fetches alarm states from the specified Milestone domain using the provided token.
 *
 ...
 */
async function getAlarmStates(domain, token) {
    const url = `http://${domain}/API/rest/v1/alarmStates`;
    const method = 'GET';
    const headers = {
    ...
    try {
        ...
        console.error('Error fetching alarm states:', error.message);
        throw new Error('Could not retrieve alarm states.');
    }
}

module.exports = { getAlarmStates };